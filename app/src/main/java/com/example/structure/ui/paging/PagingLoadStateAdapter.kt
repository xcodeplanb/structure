...
import com.example.structure.databinding.PagingLoadStateFooterViewItemBinding
...
class PagingLoadStateAdapter(
    ...
    override fun onBindViewHolder(
        ...
        holder.bind(loadState, viewModel)
    }
    ...
    override fun onCreateViewHolder(
        ...
        return PagingLoadStateViewHolder(
            PagingLoadStateFooterViewItemBinding.inflate(
    ...
    class PagingLoadStateViewHolder(
        ...
        fun bind(loadState: LoadState, viewModel: PagingViewModel) {
